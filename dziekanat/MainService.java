 ...
 * 
 */
@WebServiceClient(name = "MainService", targetNamespace = "http://dziekanat/", wsdlLocation = "http://localhost:8080/dziekanat-web/Main?wsdl")
    ...
    extends Service
{
    ...
    private final static QName MAINSERVICE_QNAME = new QName("http://dziekanat/", "MainService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/dziekanat-web/Main?wsdl");
    ...
    public Main getMainPort() {
        return super.getPort(new QName("http://dziekanat/", "MainPort"), Main.class);
    }
    ...
    public Main getMainPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://dziekanat/", "MainPort"), Main.class, features);
    }
